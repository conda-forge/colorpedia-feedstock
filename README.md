...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/colorpedia-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11778&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/colorpedia-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `colorpedia` can be installed with:

```
conda install colorpedia
```

It is possible to list all of the versions of `colorpedia` available on your platform with:
